...
public class StringSet {
    ...
    public static Set<String> findUniqueWords(){
        ...
        String[] text2 = text.replaceAll("[.,!?\"\\d]","").toLowerCase().split("\\s+");
        Set<String> kelimelerTreeSet = new TreeSet<>(Arrays.asList(text2));
        System.out.println(kelimelerTreeSet.size());

        return kelimelerTreeSet;
    }
}
